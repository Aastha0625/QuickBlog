    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 bg-primary/3'>
        ...
        py-10 border-b border-gray-500/30 text-gray-500'>
            ...
            <div>
                ...
                <p className='max-w-[410px]'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aliquam quaerat odio, molestiae esse, unde quisquam harum odit quos tempora aspernatur accusamus? Quod, officia?
                Vitae, tempore nemo itaque blanditiis molestias facilis?</p>
            </div>
