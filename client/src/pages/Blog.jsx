...
const Blog = () => {
  ...
  return data ? (
    <div className='relative'>
      <img src={assets.gradientBackground} alt="" className='absolute -top-50 sm:-top-32 -z-10 opacity-50 w-full ' />
      <Navbar/>
        ...
        <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
            <img src={data.image} alt="" className='rounded-3xl mb-8 max-w-5xl'/>
              ...
              <div className='flex flex-col gap-4'>
                {comment.map((item,index)=>(
                  ...
                  max-w-xl p-4 rounded text-gray-600'>
                    ...
                    <div className='absolute right-4 bottom-3 flex item-center gap-2
            ...
            <div className='max-w-3xl mx-auto'>
              ...
              max-w-lg'>
                <input onChange={()=>setName(e.target.value)} value={name}type="text" 
                placeholder='Name' required className='w-full p-2 border
                border-gray-300 rounded outline-none' />

                <textarea onChange={()=>setContent(e.target.value)} value={content} 
                placeholder='Comment' className='w-full p-2 border border-gray-300
